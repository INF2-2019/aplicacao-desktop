...
public class ConteudosModel {
    ...
    public ConteudosModel(int id, String idEtapa, String idDisciplina, String conteudo, int ideetapas, String data, Double valor, Button[] btns, HBox hbox) {
        this.id = id;
    ...
    public ConteudosModel(int id, String idEtapa, String idDisciplina, String conteudo,String Data) {
        this.id = id;
        this.idEtapa = idEtapa;
        this.idDisciplina = idDisciplina;
        this.conteudo = conteudo;
    ...
    public ConteudosModel(int id, String idEtapa, String idDisciplina, String conteudo, String data, Double valor) {
        this.id = id;
        this.idEtapa = idEtapa;
        this.idDisciplina = idDisciplina;
        this.conteudo = conteudo;
